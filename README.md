...
Purpose of 'Catch me BCL-1' module is student education. It shows advantages of charlieplexing with seven BI-color LEDs.
This version is designed for the case when the BI-color LED has a brighter LED on pin 1.
There are many variations of bi-color LEDs on the market, so you will need to define the resistors yourself.

![PCB front](images/attiny85_catch_me_bcl-1_pcb.jpg "Catch me BCL-1 educational module")
...
[![PCB application](images/default.png)](https://youtu.be/cm7ThNZBYdQ "Catch me BCL-1 educational module example")
Photo by Robert Sedak
...
- 7 ea., 1K ohm 1/4W 1% Resistor (R6, R7, R8, R9, R10, R11, R12)
...
Design Files
------------
This project is designed using Open Source [KiCad](https://www.kicad.org/). Design files are located in the [design_files](design_files/) folder.  You can see the [schematic](images/attiny85_catch_me_bcl-1_schematic.pdf).


Gerber files
------------
You can download gerber files from [here](gerber/attiny85_catch_me_bcl-1.zip).
