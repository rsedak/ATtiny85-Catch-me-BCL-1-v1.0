...
Svrha edukacijskog modula "Uhvati me BCL-1" je edukacija učenika. Pokazuje prednosti spajanja sedam dvobojnih svjetlećih dioda u spoj charlieplexing (multipleksiranje sa tri stanja).
Ova verzija je dizajnirana za slučaj kada dvobojna svjetleću dioda ima svjetliju diodu na pinu 1.
Na tržištu postoji mnogo varijacija dvobojnih svjetlećih dioda, pa ćete morati sami definirati otpornike.

![PCB application](images/attiny85_catch_me_bcl-1_pcb.jpg "Edukacijski modul Uhvati me BCL-1")
...
[![PCB application](images/default.png)](https://youtu.be/cm7ThNZBYdQ "Edukacijski modul Uhvati me BCL-1 - primjer programiranja")
Fotografirao Robert Sedak
...
- 7 kom, 1K ohm 1/4W 1% otpornik (R6, R7, R8, R9, R10, R11, R12)
...
Gerber datoteke
------------
Gerber datoteke možete preuzeti [ovdje](gerber/attiny85_catch_me_bcl-1.zip).
